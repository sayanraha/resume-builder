  ...
  return (
    ...
    <div className="min-h-screen pb-20">
        ...
        <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
            ...
            <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-red-600 hover:bg-red-700 transition text-white rounded-md flex" >
                X
            </button>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
            ...
            <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                Move closer to your dream job with <span className=" bg-gradient-to-r from-red-700 to-red-600 bg-clip-text text-transparent text-nowrap">AI-crafted </span> resumes.
            </h1>

            <p className="max-w-md text-center text-base my-7">Create, edit and download professional resumes with AI-crafted assistance.</p>

            {/* CTA Buttons */}
            <div className="flex items-center gap-4 ">
                <Link to='/app' className="bg-red-500 hover:bg-red-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-red-400 flex items-center transition-colors">
                    Get started
